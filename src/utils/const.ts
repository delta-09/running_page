...
const CHINESE_INFO_MESSAGE = (yearLength: number, year: string): string => {
  ...
  return `我的根扎在泥土里，<br>我的心飞在白云上，<br>我的脚步走在人间的烟火寻常。<br>下面展示的是${yearStr}的数据。`;
};
...
const FULL_MARATHON_RUN_TITLE = IS_CHINESE ? '马拉松' : 'Marathon';
const HALF_MARATHON_RUN_TITLE = IS_CHINESE ? '长距离' : 'LSD';
...
const nike = 'rgb(0,255,0)'; // if you want to change the main color, modify this value in /src/styles/index.css
